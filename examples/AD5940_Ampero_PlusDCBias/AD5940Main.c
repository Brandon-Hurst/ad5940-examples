...
void AD5940AMPStructInit(void)
{
  ...
  pAMPCfg->SensorBias = 500;   			/* Sensor bias voltage between reference and sense electrodes*/
	...
	pAMPCfg->ADCRefVolt = 1.82;		/* 1.82V-->voltage measured on Vref_1V8 pin */
}
